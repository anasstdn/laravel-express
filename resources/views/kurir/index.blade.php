		...
		<table class="table table-bordered" id="example" style="width:100%">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						<a data-toggle='click-ripple' onclick='hapus("<?php echo url("kurir/".$val->id)?>")' class="btn btn-danger">Delete <span class="fa fa-trash"></span></a>
						<a href="<?php echo url("kurir/".$val->id)."/edit"?>" class="btn btn-info">Edit <span class="fa fa-pencil"></span></a>
						@if($val->verified==true)
						<a class="btn btn-danger non" onclick='disable("<?php echo url("kurir/".$val->id)."/disable"?>")' >Non-Active</a>
						@else
						<a class="btn btn-success non" onclick='activate("<?php echo url("kurir/".$val->id)."/activate"?>")' >Activate</a>
						@endif
