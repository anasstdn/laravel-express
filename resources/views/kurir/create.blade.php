@extends('layouts.app')
@section('content')
<form action="{{url('kurir/simpan')}}" method="post" name="userin">
{{csrf_field()}}
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 style="color:#2243B6"><span class="fa fa-user-circle"></span> Tambah Kurir</h3>
		</div>
		<div class="panel-body">
			<div class="col-md-4">
				<div class="form-group">
					<label for="">Kode Kurir</label>
					<input type="text" name="kode" value="<?= $kd_kurir ?>" placeholder="" readonly="" required="" class="form-control">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
