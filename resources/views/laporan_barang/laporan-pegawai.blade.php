...
<div class="col-md-12">
	<div class="row">
		...
		<a href="{{url('/laporan-barang/pegawai/1')}}" class="btn btn-success a" >Data Pegawai Active</a>
		<a href="{{url('/laporan-barang/pegawai/0')}}" class="btn btn-danger a">Data Pegawai Non-Active</a>
		<table class="table table-bordered">
			...
			<tbody>
				...
				@endforeach
				@endif
					<td colspan="3" rowspan="3" class="text-center"><h2 style="margin-top:8%">Total Pegawai</h2></td>
