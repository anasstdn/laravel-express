...
<div class="col-md-12">
	<div class="row">
		...
		<a href="{{url('/laporan-barang/kurir/1')}} " class="btn btn-success a" >Lihat Data Kurir Active</a>
		<a href="{{url('/laporan-barang/kurir/0')}} " class="btn btn-default a" style="background-color:#0099CC;color:white">Lihat Data Kurir Tidak Aktif</a>
